...
def main():
    ...
    if args.model_mode == 'b0' or args.model_mode == 'b1' or args.model_mode == 'b2' or args.model_mode == 'b3' or args.model_mode == 'b4' or args.model_mode == 'b5' or args.model_mode == 'b6' or args.model_mode == 'b7':
        best_model_path = './models/dual_efficientnet' + args.model_mode + '_' + args.sub1dataset_mode + '_' + args.transforms_mode + '/best_model100_0.' + args.eval_kappa + '.pth'
    else:
        best_model_path = './models/dual_resnet' + args.model_mode + '_' + args.sub1dataset_mode + '_' + args.transforms_mode + '/best_model100_0.' + args.eval_kappa + '.pth'

    print(best_model_path)
    # best_model_path = "./models/dual_resnet34_orig_centerv2/last_model.pth"
    ...
    testset_root = args.test1_root


    torch.serialization.add_safe_globals([Dual_network34])
